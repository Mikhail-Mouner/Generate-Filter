...
class Filter extends Generator
{
    /**
    ...
    {
        return 'app\\Http\\Filters\\' . $this->getClassName($name) . '\\' . $this->getClassName($filter) . '.php';
    }
    ...
    {
        return [
            'COLUMN_NAME' => $this->getTableName($filter),
    ...
    {
        return $this->getStubRootPath() . '/filter.stub';
    }
}
